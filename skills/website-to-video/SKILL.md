...
**Read:** [references/step-5-build.md](references/step-5-build.md), [references/launch-video-effects.md](references/launch-video-effects.md) (proven, render-deterministic effect patterns from shipped launch videos + runnable examples in `assets/effect-examples/`)
...
| [launch-video-effects.md](references/launch-video-effects.md)                      | Step 5 — proven effect patterns from shipped launch videos (lookup table + 16 runnable examples in assets/effect-examples/)                     |
